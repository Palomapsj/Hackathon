...
import { OperationNewPatientExamSectionProps } from "./types"
...
const termodeconsentimento = [
    {
        area: 'Termo de consentimento',
        termodeconsentimento: 'Selecionar'
    }
]


export const OperationNewPatientExamSection: React.FC<OperationNewPatientExamSectionProps> = (props: OperationNewPatientExamSectionProps) => {
    return (
