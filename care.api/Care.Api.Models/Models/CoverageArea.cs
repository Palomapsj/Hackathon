...
public partial class CoverageArea
{
    ...
    public Guid? PostalcodeStartId { get; set; }

    public Guid? PostalcodeEndId { get; set; }
    ...
    public bool? VipserviceZone { get; set; }
    ...
    public virtual PostalCode PostalcodeEnd { get; set; }

    public virtual PostalCode PostalcodeStart { get; set; }
