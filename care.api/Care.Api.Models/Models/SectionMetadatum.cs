...
public partial class SectionMetadatum
{
    ...
    public virtual ICollection<LanguageSectionMetadatum> LanguageSectionMetadata { get; } = new List<LanguageSectionMetadatum>();
}
