...
public partial class HealthProgramDiseaseExam
{
    public Guid Id { get; set; }

    public Guid? ExamDefinitionId { get; set; }

    public bool? CoveredByProgram { get; set; }
    ...
    public Guid? HealthProgramDiseaseId { get; set; }

    public virtual ExamDefinition ExamDefinition { get; set; }

    public virtual StringMap ExamTypeStringMap { get; set; }

    public virtual HealthProgramDisease HealthProgramDisease { get; set; }
