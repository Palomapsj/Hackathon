...
public partial class TmpInfusoesCompletoAdd
{
    ...
    public DateTime? DataCriacaoTratamento { get; set; }
    ...
    public DateTime? DataInativação { get; set; }
    ...
    public DateTime? DataPrimeiraInfusão { get; set; }

    public DateTime? DataInfusao1 { get; set; }
