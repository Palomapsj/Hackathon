...
public partial class TrainingRecord
{
    ...
    public Guid? TrainingRecordTypeStringMapId { get; set; }

    public DateTime? TrainingDate { get; set; }

    public DateTime? RecycleTrainingDate { get; set; }
    ...
    public virtual StringMap TrainingRecordTypeStringMap { get; set; }
}
