...
namespace Care.Api.Business.Models
{
    ...
    public class LogisticsResultModel
    {
        ...
        public Guid? StatusCodeStringMap { get; set; }
        ...
        public string? LogisticsTypeStringMap { get;  set; }
    ...
    public class LogisticResultModel
    {
        ...
        public string? LogisticTypeName { get; set; }
